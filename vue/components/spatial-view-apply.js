...
export function render(_ctx, _cache) {
  return (_openBlock(), _createBlock(_Fragment, null, [
    _createCommentVNode(" Generator: Adobe Illustrator 24.2.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  "),
    (_openBlock(), _createBlock("svg", {
      ...
      _createVNode("path", { d: "M8,6.9L0,9.2v3.4L8,16l8-3.4V9.2L8,6.9z M8,7.9l6.2,1.8L8,12.2L1.8,9.7L8,7.9z M1,10.4l6.5,2.6v1.6L1,11.9V10.4z M8.5,14.7\n\tv-1.6l6.5-2.6v1.4L8.5,14.7z M8,1l5.2,1.6L7.9,4.9L2.8,2.6L8,1 M8,0L0,2.5L7.9,6L16,2.5L8,0z" })
    ]))
  ], 64 /* STABLE_FRAGMENT */))
}